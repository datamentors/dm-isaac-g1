...
"""Tracking environment config for Video 007 motion mimic training.
...
@configclass
class CommandsCfg:
    """Command: track the Video 007 motion."""

    motion = mdp.MotionCommandCfg(
        asset_name="robot",
        motion_file=f"{os.path.dirname(__file__)}/video_007.npz",
...
class RobotEnvCfg(ManagerBasedRLEnvCfg):
    """Full environment config for Video 007 motion mimic training."""
