...
"""Tracking environment config for Ronaldo celebration mimic training.
...
@configclass
class CommandsCfg:
    """Command: track the Ronaldo celebration motion."""

    motion = mdp.MotionCommandCfg(
        asset_name="robot",
        motion_file=f"{os.path.dirname(__file__)}/ronaldo_celebration.npz",
...
class RobotEnvCfg(ManagerBasedRLEnvCfg):
    """Full environment config for Ronaldo celebration mimic training."""
