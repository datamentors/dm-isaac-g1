...
"""Tracking environment config for CR7 TikTok UEFA celebration mimic training.
...
@configclass
class CommandsCfg:
    """Command: track the CR7 TikTok UEFA celebration motion."""

    motion = mdp.MotionCommandCfg(
        asset_name="robot",
        motion_file=f"{os.path.dirname(__file__)}/cr7_06_tiktok_uefa.npz",
...
class RobotEnvCfg(ManagerBasedRLEnvCfg):
    """Full environment config for CR7 TikTok UEFA celebration mimic training."""
