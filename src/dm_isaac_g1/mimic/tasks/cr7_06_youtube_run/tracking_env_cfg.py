...
"""Tracking environment config for CR7 YouTube running celebration mimic training.
...
@configclass
class CommandsCfg:
    """Command: track the CR7 YouTube running celebration motion."""

    motion = mdp.MotionCommandCfg(
        asset_name="robot",
        motion_file=f"{os.path.dirname(__file__)}/cr7_06_youtube_run.npz",
...
class RobotEnvCfg(ManagerBasedRLEnvCfg):
    """Full environment config for CR7 YouTube running celebration mimic training."""
