...
"""Tracking environment config for Clip 05 YouTube 69-75s mimic training.
...
@configclass
class CommandsCfg:
    """Command: track the Clip 05 YouTube 69-75s motion."""

    motion = mdp.MotionCommandCfg(
        asset_name="robot",
        motion_file=f"{os.path.dirname(__file__)}/clip_05_youtube_69_75s.npz",
...
class RobotEnvCfg(ManagerBasedRLEnvCfg):
    """Full environment config for Clip 05 YouTube 69-75s mimic training."""
