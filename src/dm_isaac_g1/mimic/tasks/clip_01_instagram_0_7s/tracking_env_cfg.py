...
"""Tracking environment config for Clip 01 Instagram 0-7s mimic training.
...
@configclass
class CommandsCfg:
    """Command: track the Clip 01 Instagram 0-7s motion."""

    motion = mdp.MotionCommandCfg(
        asset_name="robot",
        motion_file=f"{os.path.dirname(__file__)}/clip_01_instagram_0_7s.npz",
...
class RobotEnvCfg(ManagerBasedRLEnvCfg):
    """Full environment config for Clip 01 Instagram 0-7s mimic training."""
