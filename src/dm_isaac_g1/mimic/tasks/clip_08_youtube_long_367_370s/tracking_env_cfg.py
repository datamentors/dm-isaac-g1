...
"""Tracking environment config for Clip 08 YouTube long 367-370s mimic training.
...
@configclass
class CommandsCfg:
    """Command: track the Clip 08 YouTube long 367-370s motion."""

    motion = mdp.MotionCommandCfg(
        asset_name="robot",
        motion_file=f"{os.path.dirname(__file__)}/clip_08_youtube_long_367_370s.npz",
...
class RobotEnvCfg(ManagerBasedRLEnvCfg):
    """Full environment config for Clip 08 YouTube long 367-370s mimic training."""
